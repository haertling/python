...
def init():
    if not os.path.exists("HotShot/baggingPlots"):
        os.makedirs("HotShot/baggingPlots")
    if not os.path.exists("HotShot/boostingPlots"):
        os.makedirs("HotShot/boostingPlots")
    if not os.path.exists("HotShot/dtreePlots"):
        os.makedirs("HotShot/dtreePlots")
    if not os.path.exists("HotShot/knnPlots"):
        os.makedirs("HotShot/knnPlots")
    if not os.path.exists("HotShot/logRegPlots"):
        os.makedirs("HotShot/logRegPlots")
    if not os.path.exists("HotShot/mlpPlots"):
        os.makedirs("HotShot/mlpPlots")
...
def processKRKP( ):
    ...
    for i in range(len(S[0])):
        if i == 14:
            ...
            matrix = np.c_[matrix, col_vector[:,0]]
            matrix = np.c_[matrix, col_vector[:,1]]
            matrix = np.c_[matrix, col_vector[:,2]]
    ...
    x_train, x_test, y_train, y_test = train_test_split( matrix[:, 1:40], matrix[:, 39], test_size=.5, random_state=4 )
...
def decision_tree_driverKRvKP( x_train, x_test, y_train, y_test ):
    ...
    for depth in depths:    
        ...
        for feature in features:
            ...
            confusionMatrixDriver( d_tree, x_test, y_test, "HotShot/dtreePlots/ConfusionMatrix-Depth-{}-features-{}.png".format( depth, feature ), "Depth = {}, number of features ={}".format( depth, feature ) )
            precisionRecallDriver( d_tree, x_test, y_test, "HotShot/dtreePlots/precisionRecall-Depth-{}-features-{}.png".format( depth, feature ), "Depth = {}, number of features ={}".format( depth, feature ) )
        ...
        plt.savefig("HotShot/dtreePlots/ROC-Depth-{}.png".format(depth))
...
def bagging_dtree_driverKRVKP( x_train, x_test, y_train, y_test ):
    ...
    for depth in depths:
        ...
        for bag_size in bag_sizes:
            ...
            confusionMatrixDriver( sBag, x_test, y_test,"HotShot/baggingPlots/ConfusionMatrix-Depth-{}-BS-{}.png".format( depth, bag_size ), "Depth = {}, Bag Size = {}".format( depth, bag_size ) )
            precisionRecallDriver( sBag, x_test, y_test,"HotShot/baggingPlots/precisionRecall-Depth-{}-BS-{}.png".format( depth, bag_size ), "Depth = {}, Bag Size = {}".format( depth, bag_size ) )
        ...
        plt.savefig("HotShot/baggingPlots/ROC-Depth-{}.png".format(depth))
...
def boosting_dtree_driverKRVKP( x_train, x_test, y_train, y_test ):
    ...
    for depth in depths:
        ...
        for n_estimator in n_estimators:
            ...
            confusionMatrixDriver( sBoost, x_test, y_test,"HotShot/boostingPlots/ConfusionMatrix-Depth-{}-BS-{}.png".format( depth, n_estimator ), "Depth = {}, Number of estimators = {}".format( depth, n_estimator ))
            precisionRecallDriver( sBoost, x_test, y_test,"HotShot/boostingPlots/precisionRecall-Depth-{}-BS-{}.png".format( depth, n_estimator ), "Depth = {}, Number of estimators = {}".format( depth, n_estimator ))
        ...
        plt.savefig("HotShot/boostingPlots/ROC-Depth-{}.png".format(depth))
    ...
    for alg in algorithms:
        for weight in weights:
            ...
            for num_neigh in num_of_neighbors:
                ...
                confusionMatrixDriver( neigh, x_test, y_test, "HotShot/knnPlots/confusionMatrix-{}-{}-{}.png".format( num_neigh, alg, weight ), "alg = {}, weight = {}, neighbors = {}".format( alg, weight, num_neigh ))
                precisionRecallDriver( neigh, x_test, y_test, "HotShot/knnPlots/precisionRecall-{}-{}-{}.png".format( num_neigh, alg, weight ), "alg = {}, weight = {}, neighbors = {}".format( alg, weight, num_neigh ))
            ...
            plt.savefig("HotShot/knnPlots/ROC-{}-{}.png".format(alg, weight))
...
def logReg_driver_KRVKP( x_train, x_test, y_train, y_test ):
    ...
    for solver in solvers:
        ...
        for C in Cs:
            ...
            confusionMatrixDriver( model, x_test, y_test,"HotShot/logRegPlots/ConfusionMatrix-Solver-{}-C-{}.png".format(solver,C), "Solver-{} C-{}".format(solver,C))
            precisionRecallDriver( model, x_test, y_test,"HotShot/logRegPlots/precisionRecall-Solver-{}-C-{}.png".format(solver,C), "Solver-{} C-{}".format(solver,C))
        ...
        plt.savefig("HotShot/logRegPlots/ROC-Solver-{}.png".format(solver))
...
def mlp_driver_KRVKP( x_train, x_test, y_train, y_test ):
    ...
    for activation in activations:
        ...
        for size in sizes:
            ...
            confusionMatrixDriver( mlp, x_test, y_test,"HotShot/mlpPlots/ConfusionMatrix-{}-{}-{}.png".format(activation, size[0], size[1] ), "Activation {}, Hidden Layer {}".format(activation, size ))
            precisionRecallDriver( mlp, x_test, y_test,"HotShot/mlpPlots/precisionRecall-{}-{}-{}.png".format(activation, size[0], size[1] ), "Activation {}, Hidden Layer {}".format(activation, size ))
        ...
        plt.savefig("HotShot/mlpPlots/ROC-A-{}.png".format( activation))
